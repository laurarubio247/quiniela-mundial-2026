          ...
          partidos.map((partido) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-6 cursor-pointer rounded-xl border border-slate-700 bg-slate-900 p-6 transition hover:border-yellow-400 hover:scale-[1.01]">
                        ...
                        <div className="mt-5 space-y-2">
                          ...
                          {partido.finished && (
                            <>
                              ...
                              >
                                +{prediction.points} punto{prediction.points === 1 ? "" : "s"}
                              </p>
                            </>
                          )}
                        ...
                        <div className="mt-5">
                          ...
                          {partido.finished && (
                            <p className="mt-3 text-lg text-cyan-300">
                              Resultado: {partido.home_score} - {partido.away_score}
                            </p>
                          )}
